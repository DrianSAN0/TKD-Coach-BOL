...
const s = StyleSheet.create({
  ...
  previewBox:     { width: '100%', height: 240, backgroundColor: colors.cardDark, borderRadius: 20, overflow: 'hidden', marginBottom: 16, borderWidth: 1, borderColor: colors.border },
